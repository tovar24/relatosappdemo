...
ALTER TABLE public.caracteristica
  OWNER TO postgres;
...
(
  ...
  profundidad smallint DEFAULT 0,
  refrescada boolean DEFAULT false
)
WITH (
  OIDS=FALSE
);
ALTER TABLE public.guion
  OWNER TO postgres;
...
ALTER TABLE public.instruccion
  OWNER TO postgres;
...
ALTER TABLE public.nodo_personaje
  OWNER TO postgres;
...
ALTER TABLE public.palabra_clave
  OWNER TO postgres;
...
ALTER TABLE public.palabra_clave_valor
  OWNER TO postgres;
...
ALTER TABLE public.parrafo
  OWNER TO postgres;

-- Table: public.parrafo_hijos

-- DROP TABLE public.parrafo_hijos;
...
ALTER TABLE public.parrafo_hijos
  OWNER TO postgres;
...
ALTER TABLE public.personaje_caracteristica
  OWNER TO postgres;
...
ALTER TABLE public.personaje_imagen
  OWNER TO postgres;

-- Table: public.personaje_relacion

-- DROP TABLE public.personaje_relacion;
...
ALTER TABLE public.personaje_relacion
  OWNER TO postgres;
...
ALTER TABLE public.relato_personaje
  OWNER TO postgres;
...
ALTER TABLE relato ADD primary key (id_relato, id_personaje);
...
-- Clave agena parrafo_hijos.id_guion
ALTER TABLE parrafo_hijos 
...
CREATE OR REPLACE VIEW vista_nodo_personajes AS 
select 
id_nodo,
id_personaje,
nombre,
...
numero_imagen,
presente
from nodo_personaje np left join personaje p on np.id_personaje = p.id;
